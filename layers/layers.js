...
var lyr_Vacio = new ol.layer.Vector({
    ...
    maxResolution: resoluciones.maxResolution, minResolution: resoluciones.minResolution,
    popuplayertitle: 'Numeración Xunqueira de Espadanedo', title: '<img src="styles/legend/ECONS_VACIO.png" /> Sin definir'
});
...
var lyr_Tipo = new ol.layer.Vector({
    ...
    popuplayertitle: 'Numeración Coles', 
...
// =========================================================================
var group_Municipio_Xunqueira = new ol.layer.Group({
    ...
    title: '<span class="titulo-municipio-cabecera">MUNICIPIO DE XUNQUEIRA DE ESPADANEDO</span>'
});

// Pasamos únicamente el grupo maestro a la lista oficial de capas
var layersList = [group_Municipio_Xunqueira];
